...
void window_load(Window *window)
{
  ...
  //Load font
  ResHandle font_time = resource_get_handle(RESOURCE_ID_FONT_HELVETICA_BOLD_40);
  ResHandle font_seconds = resource_get_handle(RESOURCE_ID_FONT_HELVETICA_LIGHT_30);
  ResHandle font_date = resource_get_handle(RESOURCE_ID_FONT_HELVETICA_LIGHT_30);
